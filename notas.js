...
console.log (" El alumno se llama " + escolar1.nombre + " y su apellido es " + escolar1.apellido + " su edad es  "   + escolar1.edad  + " curso al que pertenece es  "  +  escolar1.curso  +  "  su nota final "  + escolar1.notaFinal)
console.log (" el alumno  se llama " + escolar2.nombre + " y su apellido es " + escolar2.apellido +   " su edad es  "  +  escolar2.edad  +  " el curso al que pertenece es  "  +  escolar2.curso   +  "  su nota final es  "  + escolar2.notaFinal)
console.log (" el alumno  se llama " + escolar3.nombre + " y su apellido es " + escolar3.apellido +   " su edad es  "  +  escolar3.edad +  " el curso al que pertenece es  "  +  escolar3.curso   +  "  su nota final es  "  + escolar3.notaFinal)
console.log (" el alumno  se llama " + escolar4.nombre + " y su apellido es " + escolar4.apellido +   " su edad es  "  +  escolar4.edad  +  " el curso al que pertenece es  "  +  escolar4.curso   +  " su nota final es  "  + escolar4.notaFinal)
...
alert ("estudiantes aprobados Ignacio,Gabriel ,Sofia, Belén, Agustín,María ,Fernando,Soledad")